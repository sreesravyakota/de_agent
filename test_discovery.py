...
state = {
    ...
    "jira_ticket": """
GR-101: Add a new ratings_summary table

We need a new table that aggregates average rating and total review count 
per author from the reviews table.
...
This table should follow all existing patterns for staging and warehouse tables.
It should be added to the existing DAG with appropriate data quality checks.
""",
    "tree_md": "",
    "ast_map_md": "",
    "file_table_map_md": "",
